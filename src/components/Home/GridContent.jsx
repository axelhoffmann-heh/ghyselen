...
export default function GridContent() {
  return (
    <div className='grid grid-cols-4 mt-5'>
        <div className='h-96'>
            <div className='m-4 h-full flex flex-col items-center'>
                <div className='w-20 h-20 bg-slate-900 rounded-full flex justify-center items-center'>
                ...
                <div className='flex flex-col items-center justify-center mt-5'>
                    <h1 className='text-2xl font-bold text-slate-900 mb-2'>Vendre</h1>
                    <p className='text-slate-900 text-center'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptatum.</p>
                </div>
            </div>
        </div>
        <div className='h-96'>
